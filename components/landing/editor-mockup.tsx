...
// Fixed design width — the editor is authored at this size
...
export function EditorMockup() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      // Never upscale beyond 1 — only shrink to fit
  ...
  return (
    <div className="relative mt-16 md:mt-24 w-full" ref={wrapRef}>
      {/* 
        Outer spacer reserves the scaled-down vertical height 
        so surrounding content doesn't overlap the transformed card.
        transform doesn't affect layout flow, hence this wrapper.
      */}
      <div
        className="relative w-full"
        style={{ height: `${Math.ceil(560 * scale)}px` }}
      >
        {/* 
          The actual mockup — rendered at fixed DESIGN_WIDTH, 
          then visually scaled. transform-origin top-left keeps it 
          anchored to the wrapper's top edge.
        */}
        <div
                ...
                <div className="flex flex-col border-l border-white/[0.07] bg-[#0d0d0d]">
                  ...
                  <div className="flex flex-col gap-3 overflow-y-auto p-3">
                    ...
                    <div>
                      ...
                      <div className="w-full rounded-[7px] border border-white/[0.08] bg-white/[0.03] p-2 text-[10px] leading-relaxed text-white/60 h-[56px] overflow-hidden">
                        A powerful moment unfolds in this manga panel — the story
                        continues to build.
                      </div>
                    </div>
